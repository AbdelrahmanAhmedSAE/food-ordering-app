...
export type ProductCategoryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"isPrimary" | "productId" | "categoryId" | "createdAt" | "updatedAt", ExtArgs["result"]["productCategory"]>
...
export interface ProductCategoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `isPrimary`
   * const productCategoryWithIsPrimaryOnly = await prisma.productCategory.findMany({ select: { isPrimary: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProductCategories and only return the `isPrimary`
   * const productCategoryWithIsPrimaryOnly = await prisma.productCategory.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProductCategories and only return the `isPrimary`
   * const productCategoryWithIsPrimaryOnly = await prisma.productCategory.updateManyAndReturn({
   *   select: { isPrimary: true },
   *   where: {
   *     // ... provide filter here
   *   },
